...
const TRUST_ITEMS = [
  { title: 'Fully insured', text: 'Goods-in-transit cover on booked moves with careful handling throughout.' },
  { title: 'Instant online quote', text: 'Transparent pricing based on your addresses, items, and move date.' },
  { title: 'Professional crews', text: 'Experienced movers who communicate clearly before and on move day.' },
  { title: 'Scotland & UK routes', text: 'Local jobs in your town plus longer Scottish and UK relocations.' },
]
    ...
    <div className="min-w-0">
      ...
      >
        ...
        <div className="relative mx-auto min-w-0 max-w-6xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8">
          <nav className="text-xs font-medium text-brand-200/90 sm:text-sm">
      ...
      <section className="border-b border-slate-200 bg-white py-10 sm:py-14">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-slate-700">
            <p className="text-base leading-relaxed sm:text-lg">{page.intro}</p>
            <p className="mt-4 text-sm leading-relaxed text-slate-600 sm:text-base">{page.introSecondary}</p>
          </div>
        </div>
      </section>

      <section className="border-b border-slate-200 bg-slate-50 py-10 sm:py-14" aria-labelledby="seo-services-heading">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <h2 id="seo-services-heading" className="text-xl font-bold tracking-tight text-slate-900 sm:text-2xl">
            Services in {page.cityName}
          </h2>
          ...
          <ul className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {SERVICE_LINKS.map(({ to, label }) => (
              <li key={to}>
                <Link
                  to={to}
                  className="flex min-h-[52px] items-center justify-between rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-800 shadow-sm transition hover:border-brand-300 hover:text-brand-800"
                >
                  {label}
      ...
      <section className="border-b border-slate-200 bg-white py-10 sm:py-14" aria-labelledby="seo-trust-heading">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <h2 id="seo-trust-heading" className="text-xl font-bold tracking-tight text-slate-900 sm:text-2xl">
            Why book ShiftMyHome in {page.cityName}
          </h2>
      ...
      <section className="border-b border-slate-200 bg-slate-50 py-10 sm:py-14" aria-labelledby="seo-faq-heading">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <h2 id="seo-faq-heading" className="text-xl font-bold tracking-tight text-slate-900 sm:text-2xl">
            Frequently asked questions — {page.cityName}
          </h2>
      ...
      <section className="border-b border-slate-200 bg-brand-950 py-10 text-white sm:py-12" aria-labelledby="seo-cta-heading">
        <div className="mx-auto max-w-6xl px-4 text-center sm:px-6 lg:px-8">
          <h2 id="seo-cta-heading" className="text-xl font-bold sm:text-2xl">
            Ready for your {page.cityName} move?
          </h2>
      ...
      {page.relatedLinks.length > 0 ? (
        <section className="border-b border-slate-200 bg-white py-8 sm:py-10" aria-labelledby="seo-related-heading">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <h2 id="seo-related-heading" className="text-lg font-bold text-slate-900">
              Related pages
            </h2>
