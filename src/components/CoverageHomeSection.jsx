...
export default function CoverageHomeSection() {
  return (
    <section id="coverage" className="scroll-mt-20 border-t border-slate-200 bg-slate-50 py-14 sm:py-20">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">Coverage</h2>
