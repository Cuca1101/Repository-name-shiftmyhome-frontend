...
/**
 * @param {{ marketplaceQuotes: Record<string, unknown>[], onApplied: () => void | Promise<void>, compact?: boolean }} props
 */
export default function MarketplacePricingSettingsPanel({ marketplaceQuotes, onApplied, compact = false }) {
