...
export default function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="public-quote-section scroll-mt-[60px] border-t border-slate-200 bg-slate-50 py-8 md:scroll-mt-[76px] md:py-12 lg:py-24"
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl lg:text-4xl">Quote request</h2>
          <p className="mt-4 text-base text-slate-600 sm:text-lg">
            Send your details and we&apos;ll get back with confirmation and availability.
          </p>
        </div>

        <div className="mx-auto mt-10 grid min-w-0 max-w-5xl gap-8 lg:grid-cols-5 lg:gap-12">
