...
export const INVENTORY_BY_CATEGORY = {
  ...
  kitchen: {
    ...
    items: [
      ...
      { id: 'cooker', name: 'Cooker / oven', m3: 0.6, weightType: 'heavy', mult: 1.1, heavyFee: false },
  ...
  garage: {
    ...
    items: [
      ...
      { id: 'treadmill', name: 'Treadmill', m3: 1.2, weightType: 'heavy', mult: 1.2, heavyFee: true },
  ...
  sports: {
    ...
    items: [
      ...
      { id: 'upright-piano', name: 'Upright piano', m3: 1.2, weightType: 'heavy', mult: 1.3, heavyFee: true },
