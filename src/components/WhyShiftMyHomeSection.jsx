    ...
    <section id="why-us" className="scroll-mt-20 bg-white py-16 sm:py-24">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">Why ShiftMyHome</h2>
        ...
        <ul className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {CARDS.map(({ title, description, icon }) => (
            <li
              key={title}
              className="flex flex-col rounded-2xl border border-slate-200/90 bg-slate-50/80 p-6 shadow-card transition hover:border-brand-200 hover:shadow-card-hover"
            >
              <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-brand-500 to-emerald-600 text-white shadow-md shadow-brand-600/25">
                {icon}
              </div>
