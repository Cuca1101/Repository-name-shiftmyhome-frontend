...
import { CONTACT, WHATSAPP_URL, resolveWhatsAppUrl } from '../config'
...
export default function Footer() {
  ...
  return (
    <footer className="site-footer-premium text-slate-300">
      <div className="mx-auto min-w-0 max-w-6xl px-4 py-10 sm:px-6 sm:py-14 lg:px-8">
        <div className="grid min-w-0 grid-cols-1 gap-8 lg:grid-cols-4 lg:gap-12">
          <div className="min-w-0 lg:col-span-1">
            ...
            <p className="mt-2 hidden max-w-sm text-xs leading-relaxed text-slate-500 xs:block">
              Professional Scotland removals from Glasgow and Edinburgh to towns across the UK.
            </p>
            <div className="mt-4 flex flex-wrap gap-2 sm:mt-5">
              <SocialIcon href={resolveWhatsAppUrl(social.whatsapp, { withQuoteText: true })} label="WhatsApp">
              ...
              <SocialIcon href={social.facebook || FACEBOOK_URL} label="Facebook">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
          ...
          <div className="grid w-full grid-cols-3 gap-x-3 gap-y-4 sm:gap-x-5 lg:contents lg:gap-y-0">
            <FooterNavColumn title="Quick Links" className="min-w-0 lg:w-auto">
            ...
            <FooterNavColumn title="Services" className="min-w-0 lg:w-auto">
              <ul className="footer-nav-list">
            ...
            <FooterNavColumn title="Contact" className="min-w-0 lg:w-auto">
            <ul className="footer-nav-list space-y-2 sm:space-y-3">
              <li>
                <a href={`tel:${phoneTel}`} className="inline-flex min-h-[36px] items-center gap-1.5 text-[13px] text-slate-300 hover:text-white sm:min-h-[44px] sm:gap-2.5 sm:text-sm">
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex min-h-[36px] w-auto items-center justify-center gap-1.5 rounded-full bg-[#25D366] px-3 py-1.5 text-xs font-semibold text-white shadow-md transition hover:bg-[#20bd5a] sm:min-h-[40px] sm:gap-2 sm:px-4 sm:py-2 sm:text-sm"
                >
              ...
              <li className="hidden gap-2 pt-1 text-xs leading-relaxed text-slate-400 sm:flex">
                <span className="mt-0.5 shrink-0 text-slate-400" aria-hidden>
                  <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="mt-8 border-t border-slate-800 pt-6 sm:mt-12 sm:pt-8">
          <div className="flex flex-col items-center gap-4 text-center sm:flex-row sm:flex-wrap sm:items-center sm:justify-between sm:text-left">
            <ul className="flex flex-wrap justify-center gap-x-5 gap-y-2 text-xs text-slate-500 sm:justify-start">
