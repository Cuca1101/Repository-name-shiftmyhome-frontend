...
const quickLinks = [
  ...
  { sectionId: 'quote', label: 'Get Free Quote' },
]
...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-slate-800 bg-gradient-to-b from-slate-950 to-slate-900 text-slate-300">
      <div className="mx-auto min-w-0 max-w-6xl px-4 py-12 sm:px-6 sm:py-14 lg:px-8">
        <div className="grid min-w-0 gap-10 sm:grid-cols-2 lg:grid-cols-4 lg:gap-12">
          <div className="sm:col-span-2 lg:col-span-1">
            <p className="text-sm font-semibold uppercase tracking-wide text-white">About ShiftMyHome</p>
            <Link
              to="/"
              className="mt-3 inline-block rounded-lg outline-none ring-offset-slate-900 focus-visible:ring-2 focus-visible:ring-brand-500"
            >
              <Logo variant="dark" />
            </Link>
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-slate-400">
              Professional removals, delivery, and man-with-van services from Glasgow. Whether you are moving home,
              shifting furniture, or need a reliable UK-wide relocation, we plan every job with care.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm">
              <li>
                <a href={`tel:${CONTACT.phoneTel}`} className="inline-flex items-center gap-2 text-slate-300 hover:text-white">
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex min-h-[40px] items-center gap-2 rounded-full bg-[#25D366] px-4 py-2 text-sm font-semibold text-white shadow-md transition hover:bg-[#20bd5a]"
                >
