...
export const SERVICE_PAGES = [
  ...
  },
  {
    ...
    shortDescription:
      'Flexible help for smaller loads, single trips, and quick jobs. Ideal when you need a van and an extra pair of hands.',
  ...
  },
  {
    ...
    shortDescription:
      'Sofas, beds, and bulky items moved safely with blankets, straps, and the right vehicle size.',
  ...
  },
  {
    ...
    shortDescription:
      'Desks, IT, and office furniture relocated with planning to keep your business running.',
  ...
  },
  {
    ...
    shortDescription:
      'Budget-friendly moves between halls, shared flats, and term-time addresses across Glasgow and beyond.',
