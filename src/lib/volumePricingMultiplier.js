/**
 * Volume scaling multipliers — applied to inventory volume £ and optionally stairs access
 * (floor / no-lift / with-lift) via the same bands. Never scales the whole quote.
